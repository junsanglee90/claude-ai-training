/**
 * user.js — 수강신청 사용자 페이지
 * Step 1: 정보 입력 → Step 2: 일정 선택 → Step 3: 사전 체크 → Step 4: 완료
 */
...
// ─── Step 3 → Step 2: 서베이에서 뒤로 ───
function goToStep2FromSurvey() {
  showStep(2);
}
